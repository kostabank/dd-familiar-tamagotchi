-- D&D Familiar Tamagotchi — Setup script (run AFTER supabase-schema.sql)
-- This disables RLS (Row-Level Security) so the Next.js API can read/write freely,
-- and inserts seed data (DM account + 24 evolution options + 13 achievements).

-- ============================================================
-- PART 1: Disable RLS on all tables (app uses JWT auth, not Supabase RLS)
-- ============================================================
